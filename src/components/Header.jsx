...
const Header = () => {
  ...
  <div className="container-fluid ">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-kanban-fill" viewBox="0 0 16 16">
    ...
    <div className="offcanvas offcanvas-end w-75" tabIndex="-1" id="offcanvas" aria-labelledby="offcanvasLabel" >
      ...
      <div className="offcanvas-body">
        ...
        <li className="nav-item ln  px-4"><a className=" navigateLink" href="#aboutus" ><span className='insideH1'>About us</span></a></li>
          ...
          <li className="nav-item ln  px-4"><a className=" navigateLink" href="#workgallery" ><span className='insideH1'>Work gallery</span></a></li>
