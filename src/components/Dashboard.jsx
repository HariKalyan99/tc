...
const Dashboard = () => {
  ...
  const contactTexts = [
    {text: "Thank you for your interest in reaching out to us. Whether you have questions, feedback, or inquiries, we're here to assist you. Please swipe right, you can get in touch with us in various ways:", heading:' ContactUs:'},
